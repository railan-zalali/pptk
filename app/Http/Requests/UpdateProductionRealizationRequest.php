...
class UpdateProductionRealizationRequest extends FormRequest
{
    ...
    {
        $id = $this->route('production_realization')?->id;
        ...
        return [
            ...
            'month'    => [
                ...
                'min:1',
                'max:12',
                Rule::unique('production_realizations')
                    ->ignore($id)
                    ->where(fn ($q) => $q->where('kebun_id', $this->kebun_id)->where('year', $this->year)),
            ],
