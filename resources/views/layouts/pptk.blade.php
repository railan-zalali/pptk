...
<body class="font-sans antialiased tea-pattern dark:bg-gray-900 dark:text-gray-100">
    <div class="min-h-screen">
        <!-- Navigation -->
        <nav class="no-print bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm shadow-lg sticky top-0 z-50">
        ...
        <!-- Footer -->
        <footer class="no-print bg-gradient-to-r from-green-800 to-green-600 text-white mt-16">
