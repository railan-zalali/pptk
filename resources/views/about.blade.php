...
<section class="py-16 bg-gradient-to-r from-green-600 to-green-700 text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 class="text-4xl md:text-5xl font-bold mb-4">Tentang Kebun Model</h1>
        <p class="text-xl opacity-90 max-w-3xl mx-auto">
            Memahami peran penting kebun model teh dalam pengembangan pertanian berkelanjutan dan penelitian agrikultur
        </p>
    </div>
</section>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="pptk-card p-8 mb-12">
            <div class="flex items-center mb-6">
                <div class="w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-xl flex items-center justify-center mr-4">
            ...
            <p class="text-gray-700 leading-relaxed mb-4">
                Kebun model teh merupakan unit penelitian dan pengembangan yang strategis dalam mendukung program pemuliaan dan budidaya tanaman teh di Indonesia. PPTK Gambung mengelola beberapa kebun model tersebar di berbagai wilayah untuk mendukung penelitian terapan dan demonstrasi teknologi.
            </p>
            <p class="text-gray-700 leading-relaxed">
                Dengan pendekatan kebun model, PPTK Gambung dapat menguji berbagai teknologi budidaya, evaluasi genetik, serta praktik pengelolaan kebun yang optimal sebelum diaplikasikan secara luas kepada petani teh.
            </p>
        </div>
        ...
        <div class="space-y-6">
            ...
            <div class="border border-gray-200 rounded-lg overflow-hidden">
                <button class="accordion-header w-full px-6 py-4 text-left bg-gray-50 hover:bg-green-50 transition-colors duration-200 flex items-center justify-between" onclick="toggleAccordion('sejarah')">
                ...
                <div class="accordion-content hidden px-6 py-4 bg-white" id="sejarah-content">
                    <div class="prose text-gray-700">
                        <p class="mb-4">
                            Konsep kebun model teh di Indonesia dimulai sejak tahun 1980-an sebagai bagian dari program intensifikasi pertanian teh. PPTK Gambung mulai membangun kebun model pertama di kawasan Malabar, Bandung.
                        </p>
                        <ul class="list-disc pl-6 space-y-2 mb-4">
                            <li><strong>1985:</strong> Pembangunan kebun model pertama di Malabar dengan luas 150 hektar</li>
                            <li><strong>1988:</strong> Pengembangan kebun model Sedep di Garut untuk uji varietas unggul</li>
                            <li><strong>1990:</strong> Pembangunan kebun model Ranca Bali dengan sistem irigasi modern</li>
                            <li><strong>1992:</strong> Ekspansi kebun model Kaligua di Brebes untuk dataran rendah</li>
                            <li><strong>2000-an:</strong> Integrasi teknologi precision agriculture dan monitoring digital</li>
                        </ul>
                        <p>
                            Perkembangan ini menunjukkan komitmen PPTK Gambung dalam mendukung modernisasi pertanian teh Indonesia melalui pendekatan berbasis penelitian dan demonstrasi.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <!-- Tujuan PPTK -->
            <div class="border border-gray-200 rounded-lg overflow-hidden">
                <button class="accordion-header w-full px-6 py-4 text-left bg-gray-50 hover:bg-green-50 transition-colors duration-200 flex items-center justify-between" onclick="toggleAccordion('tujuan')">
                    <div class="flex items-center">
                ...
                <div class="accordion-content hidden px-6 py-4 bg-white" id="tujuan-content">
                    <div class="prose text-gray-700">
                        <p class="mb-4">
                            Pusat Penelitian Teh dan Kina (PPTK) Gambung memiliki peran strategis dalam pengembangan komoditas teh dan kina di Indonesia dengan tujuan utama:
                        </p>
            ...
            <!-- Manfaat Kebun Model -->
            <div class="border border-gray-200 rounded-lg overflow-hidden">
                <button class="accordion-header w-full px-6 py-4 text-left bg-gray-50 hover:bg-green-50 transition-colors duration-200 flex items-center justify-between" onclick="toggleAccordion('manfaat')">
                    <div class="flex items-center">
                ...
                <div class="accordion-content hidden px-6 py-4 bg-white" id="manfaat-content">
                    <div class="prose text-gray-700">
                        <p class="mb-4">
                            Kebun model teh memberikan berbagai manfaat strategis bagi pengembangan industri pertanian teh Indonesia:
                        </p>
                        <div class="space-y-4">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">Menguji efektivitas teknologi budidaya baru sebelum diaplikasikan secara luas</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">Menyediakan tempat praktik dan pembelajaran bagi petani, mahasiswa, dan peneliti</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">Demonstrasi praktik terbaik untuk meningkatkan hasil panen dan kualitas</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">Mengembangkan praktik pertanian berkelanjutan yang ramah lingkungan</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">Mengoptimalkan penggunaan sumber daya dan biaya produksi</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Lokasi Kebun Model -->
            <div class="border border-gray-200 rounded-lg overflow-hidden">
                <button class="accordion-header w-full px-6 py-4 text-left bg-gray-50 hover:bg-green-50 transition-colors duration-200 flex items-center justify-between" onclick="toggleAccordion('lokasi')">
                    <div class="flex items-center">
                ...
                <div class="accordion-content hidden px-6 py-4 bg-white" id="lokasi-content">
                    <div class="prose text-gray-700">
                        <p class="mb-4">
                            PPTK Gambung mengelola kebun model tersebar di berbagai wilayah Indonesia yang mewakili berbagai kondisi agroklimat:
                        </p>
                        <div class="grid md:grid-cols-2 gap-6">
                            <div class="border border-green-200 rounded-lg p-4">
                                ...
                                <ul class="text-sm text-gray-700 space-y-1">
                                    ...
                                    <li><strong>Ranca Bali:</strong> Ketinggian 1.000-1.300 mdpl, luas 120 hektar</li>
                            ...
                            <div class="border border-purple-200 rounded-lg p-4">
                                ...
                                <ul class="text-sm text-gray-700 space-y-1">
                                    <li><strong>Pagar Alam:</strong> Ketinggian 1.400-1.700 mdpl, luas 180 hektar</li>
