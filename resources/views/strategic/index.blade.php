...
@section('content')
    ...
    <!-- Regional Navigation -->
    <section id="wilayah" class="py-16 bg-white scroll-mt-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    @foreach ($regions as $region)
                        <div class="pptk-card p-6 group hover:border-green-500 transition-all duration-300"
                            ...
                            <div class="flex gap-3">
                                ...
                                <a href="{{ route('dashboard.garden') }}"
                                    class="px-4 py-3 rounded-lg border border-green-200 text-green-700 bg-green-50 hover:bg-green-100 font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-300">
                                    Dashboard
                                </a>
                            </div>
                        </div>
