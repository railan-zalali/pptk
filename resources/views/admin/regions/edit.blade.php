        ...
        <form action="{{ route('admin.regions.update', $region) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input name="province" type="text" required class="w-full border rounded px-3 py-2"
                ...
                <div class="md:col-span-2">
                    ...
                    <input name="coordinates" type="text" class="w-full border rounded px-3 py-2"
                        value="{{ old('coordinates', $region->coordinates) }}">
                </div>
                <div class="md:col-span-2">
                ...
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Foto Tambahan (multi-upload)</label>
                    ...
                    @if($region->photos && $region->photos->count())
                        <div class="mt-3 grid grid-cols-2 md:grid-cols-4 gap-3">
                            @foreach($region->photos as $p)
                                <img src="{{ asset('storage/' . $p->path) }}" alt="Foto Wilayah" class="w-full h-24 object-cover rounded">
                            @endforeach
                        </div>
                    @endif
                </div>
