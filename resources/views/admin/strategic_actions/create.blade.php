...
@section('title', 'Tambah Strategic Action')
...
@section('content')
    <div class="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        <div class="mb-6">
            ...
            <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-100">Form Tambah Strategic Action</h2>
        </div>
        ...
        <form action="{{ route('admin.strategic-actions.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <input type="date" name="period" id="period" value="{{ old('period') }}"
                        class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200"
                        required>
                    @error('period')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                ...
                <div class="col-span-2">
                    ...
                    <select name="action_type" id="action_type"
                        ...
                        <option value="fertilizer_root" {{ old('action_type') == 'fertilizer_root' ? 'selected' : '' }}>Pemupukan Akar</option>
                        <option value="fertilizer_leaf" {{ old('action_type') == 'fertilizer_leaf' ? 'selected' : '' }}>Pemupukan Daun</option>
                        <option value="cultivator" {{ old('action_type') == 'cultivator' ? 'selected' : '' }}>Kultivator</option>
                        <option value="weed_control" {{ old('action_type') == 'weed_control' ? 'selected' : '' }}>Pengendalian Gulma</option>
                    </select>
                    @error('action_type')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="target_volume" id="target_volume" value="{{ old('target_volume') }}"
                        class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200"
                        required>
                    @error('target_volume')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="realization_volume" id="realization_volume" value="{{ old('realization_volume') }}"
                        class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200"
                        required>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="nitrogen_content" id="nitrogen_content" value="{{ old('nitrogen_content') }}"
                        class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200">
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="notes" id="notes" rows="3"
                        class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200">{{ old('notes') }}</textarea>
                    @error('notes')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
