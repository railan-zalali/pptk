    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
        <div class="mb-6 border-b border-gray-100 dark:border-gray-700 pb-4">
            <h3 class="text-xl font-bold text-gray-800 dark:text-gray-100 flex items-center gap-2">
                <span class="material-icons-outlined text-green-600">manage_accounts</span>
                Edit User
            </h3>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1 ml-8">Perbarui informasi dan hak akses pengguna.</p>
        </div>
        ...
        <form action="{{ route('admin.users.update', $user) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <select name="role" id="role"
                            ...
                            <option value="admin_pptk" {{ old('role', $user->role) == 'admin_pptk' ? 'selected' : '' }}>Admin PPTK (Operasional)
                            </option>
                            <option value="manajemen" {{ old('role', $user->role) == 'manajemen' ? 'selected' : '' }}>Manajemen (View Only)
                            </option>
                        </select>
                    </div>
                    @error('role')
                ...
                <div class="md:col-span-2 mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                    <h4 class="text-sm font-semibold text-gray-800 dark:text-gray-100 mb-4 flex items-center gap-2">
                        <span class="material-icons-outlined text-gray-400">lock</span>
                        Ganti Password (Opsional)
                    </h4>
                    <p class="text-xs text-gray-500 dark:text-gray-400 mb-4">Kosongkan jika tidak ingin mengubah password.
                    </p>
                </div>
                ...
                <div>
                    <label for="password_confirmation"
                        class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Konfirmasi
                        Password</label>
                    <div class="relative">
                        <span class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
