            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input name="area_hectares" type="number" step="0.01" required
                        class="w-full border rounded px-3 py-2" value="{{ old('area_hectares') }}">
                </div>
                <div>
                    ...
                    <input name="coordinates" type="text" class="w-full border rounded px-3 py-2"
                        value="{{ old('coordinates') }}" placeholder="Contoh: -7.1234,107.5678">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input name="garden_type" type="text" class="w-full border rounded px-3 py-2"
                        value="{{ old('garden_type') }}" placeholder="contoh: perkebunan / penelitian">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">pH Tanah</label>
                    <input name="soil_ph" type="number" step="0.1" class="w-full border rounded px-3 py-2"
                        value="{{ old('soil_ph') }}">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Jenis Tanah</label>
                    <input name="soil_type" type="text" class="w-full border rounded px-3 py-2"
                        value="{{ old('soil_type') }}">
                </div>
                ...
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Foto Kebun (opsional)</label>
                ...
                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Foto Galeri (multi-upload)</label>
