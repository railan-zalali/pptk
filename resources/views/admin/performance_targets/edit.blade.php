...
@section('content')
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1 ml-8">Perbarui target produktivitas tahunan untuk kebun.
            </p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="year" value="{{ old('year', $performanceTarget->year) }}" required
                            min="2000" max="2099"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" name="target_protas_min"
                            value="{{ old('target_protas_min', $performanceTarget->target_protas_min) }}" required
                            class="w-full pl-9 pr-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-colors"
                            placeholder="0.00">
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" name="target_protas_max"
                            value="{{ old('target_protas_max', $performanceTarget->target_protas_max) }}" required
                            class="w-full pl-9 pr-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-colors"
                            placeholder="0.00">
                    </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="relative">
                        ...
                        <textarea name="note" rows="3"
                            class="w-full pl-9 pr-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-colors"
                            placeholder="Tambahkan catatan...">{{ old('note', $performanceTarget->note) }}</textarea>
                    </div>
                    @error('note')
                        <p class="text-red-500 text-xs mt-1 flex items-center gap-1">
                            <span class="material-icons-outlined text-[14px]">error</span>
