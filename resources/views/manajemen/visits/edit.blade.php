    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
        <div class="mb-6 border-b border-gray-200 dark:border-gray-700 pb-4">
            <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100 flex items-center gap-2">
                ...
                Edit Kunjungan Dinas
            </h2>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Perbarui informasi kunjungan dinas.</p>
        </div>

        <form action="{{ route('manajemen.visits.update', $visit) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="title"
                            ...
                            required value="{{ old('title', $visit->title) }}">
                    </div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="date" name="visit_date"
                            class="w-full pl-9 pr-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-colors"
                            required value="{{ old('visit_date', $visit->visit_date->format('Y-m-d')) }}">
                    </div>
                </div>
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="duration" min="1" max="24"
                            class="w-full pl-9 pr-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-colors"
                            required value="{{ old('duration', $visit->duration) }}">
                    </div>
                </div>
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="participants_count" min="1"
                            class="w-full pl-9 pr-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-colors"
                            required value="{{ old('participants_count', $visit->participants_count) }}">
                    </div>
                </div>
                <div>
                    ...
                    <div class="relative">
                        ...
                        <select name="status"
                            class="w-full pl-9 pr-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-colors appearance-none"
                            required>
                            <option value="scheduled" {{ $visit->status == 'scheduled' ? 'selected' : '' }}>Dijadwalkan
                            </option>
                            <option value="completed" {{ $visit->status == 'completed' ? 'selected' : '' }}>Selesai
                            </option>
                            <option value="cancelled" {{ $visit->status == 'cancelled' ? 'selected' : '' }}>Dibatalkan
                            </option>
                        </select>
                    </div>
                </div>
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <textarea name="participants_list" rows="3"
                        class="w-full pl-9 pr-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-colors">{{ old('participants_list', $visit->participants_list) }}</textarea>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <textarea name="description" rows="4"
                        class="w-full pl-9 pr-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-colors"
                        required>{{ old('description', $visit->description) }}</textarea>
                </div>
            </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <textarea name="objectives" rows="3"
                            class="w-full pl-9 pr-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-colors">{{ old('objectives', $visit->objectives) }}</textarea>
                    </div>
                </div>
                <div>
                    ...
                    <div class="relative">
                        ...
                        <textarea name="findings" rows="3"
                            class="w-full pl-9 pr-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-colors">{{ old('findings', $visit->findings) }}</textarea>
                    </div>
                </div>
                <div>
                    ...
                    <div class="relative">
                        ...
                        <textarea name="recommendations" rows="3"
                            class="w-full pl-9 pr-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-colors">{{ old('recommendations', $visit->recommendations) }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <select name="rating"
                            ...
                            required>
                            @for ($i = 1; $i <= 5; $i++)
                                <option value="{{ $i }}" {{ $visit->rating == $i ? 'selected' : '' }}>
                                    {{ $i }} Bintang</option>
                            @endfor
                        </select>
                    </div>
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Format: JPG, PNG, GIF. Maks: 2MB per file.
                        Biarkan kosong jika tidak ingin mengubah foto.</p>
                </div>
            </div>
